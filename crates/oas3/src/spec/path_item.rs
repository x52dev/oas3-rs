...
pub struct PathItem {
    ...
    /// undefined.
    ///
    /// [Path Item Object]: https://spec.openapis.org/oas/v3.1.1#pathItemObject
    ...
    /// [OpenAPI Object's components/parameters]: https://spec.openapis.org/oas/v3.1.1#componentsParameters
    #[serde(default, skip_serializing_if = "Vec::is_empty")]
